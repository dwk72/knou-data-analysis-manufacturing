...
다음 단계에서는 같은 분석기법을 배터리·화학 생산기술 문제에 맞게 확장합니다. 제조 Case, 데이터 구조, 합성 데이터 생성 원칙은 [07_manufacturing_extension](./07_manufacturing_extension/)에 설계했습니다. 아래 분석 구현은 아직 진행 전입니다.
